...
function saludarPersonalizado(nombre, apellido) {
    ...
    return "Hola, " + nombre + " " + apellido; // concatenamos saludo mas nombre y apellido
}
console.log(saludarPersonalizado("Ruth", "Velázquez")); // Imprimir
...
console.log(dividir(20, 10));// imrpime 2
...
console.log(funcionMultiplicar(7, 4)); // Imprime 28
...
//  }
   ...
   console.log(multiplicarFlecha(5, 4));
...
// 4.2 Crea una función flecha llamada `saludarFlecha` que reciba un parámetro `nombre` y devuelva "Hola [nombre]".
    ...
    console.log(saludarFlecha("Ruth"));
...
console.log(suma(4)); // Imprime 10 (1 + 2 + 3 + 4)
...
// 5.2 Escribe una función que calcule la sucesión de Fibonacci de forma recursiva. La sucesión de Fibonacci es una serie de números que empieza por 0 y 1 y cada número es la suma de los dos anteriores. Por ejemplo: `fibonacci(6) -> 8
    ...
    console.log(fibonacci(8)); // Imprime 21 (0, 1, 1, 2, 3, 5, 8, 13, 21.)
...
console.log(factorial(6)); // Imprime 720
